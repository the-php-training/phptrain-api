...
namespace Tenant\Presentation\Http\Controller;

use Tenant\Application\Command\CreateTenantCommand;
use Tenant\Application\Command\CreateTenantHandler;
use Tenant\Application\DTO\CreateTenantDTO;
use Tenant\Application\Query\GetTenantHandler;
use Tenant\Application\Query\GetTenantQuery;
use Tenant\Application\Query\ListTenantsHandler;
use Tenant\Application\Query\ListTenantsQuery;
